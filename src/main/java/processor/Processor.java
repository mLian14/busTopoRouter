...
//        executor.getEnv().dispose();
    ...
    public void buildCons(ArrayList<Obstacle> obstacles, ArrayList<VirtualPointVar> virtualPointVars, ArrayList<PseudoBase> slaves, PseudoBase master, GurobiVariable busMin, GurobiVariable busDiff, GurobiVariable branchMin, GurobiVariable branchDiff) throws GRBException {
        ...
        //Master Relevant
        buildCons_Master(obstacles, virtualPointVars, master, c_busMin, c_busDiff);
...
//                    executor.addConstraint(c);
    ...
    private void buildCons_Master(ArrayList<Obstacle> obstacles, ArrayList<VirtualPointVar> virtualPointVars, PseudoBase master, GurobiConstraint c_busMin, GurobiConstraint c_busDiff) throws GRBException {
        GurobiConstraint c;
        VirtualPointVar vp = virtualPointVars.get(0);
        //VM_cnn.4
